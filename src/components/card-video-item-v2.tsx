...
export default function CardVideoItem({
    ...
    return (
        <article className={cn("relative inline-block w-full pt-[133.333%] overflow-hidden rounded-md group")}>
            ...
            <div className="absolute bottom-0 left-0 w-full z-40  px-3  pb-[17px] h-[60%] bg-gradient-to-t from-[rgba(22,24,35,0.6)] via-transparent flex flex-col  justify-center items-center">
                ...
                <h4 className="text-lg text-white font-bold text-ellipsis overflow-hidden mt-2">{author.username}</h4>
                <div className="mb-2 flex items-center gap-1">
                    <h5 className="text-sm text-white font-semibold text-ellipsis overflow-hidden ">{author.name}</h5>
