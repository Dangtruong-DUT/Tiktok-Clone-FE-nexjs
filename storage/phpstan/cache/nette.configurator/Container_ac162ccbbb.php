...
class Container_ac162ccbbb extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ac162ccbbb $container)
			{
	...
	public function createServiceContainer(): Container_ac162ccbbb
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/opt/homebrew/Cellar/php@8.2/8.2.30/bin/php',
