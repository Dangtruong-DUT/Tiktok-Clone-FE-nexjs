...
const RootCommentsContext = createContext<RootCommentsContextProps | undefined>(
  undefined,
);
...
export default function CommentList({
  ...
  const { data, fetchNextPage, hasNextPage, isLoading } =
    useGetCommentsInfiniteQuery(postUuid, {
...
export function useRootCommentsContext() {
  ...
  if (!context) {
    throw new Error(
      "useRootCommentsContext must be used within a RootCommentsProvider",
    );
  }
  return context;
}
