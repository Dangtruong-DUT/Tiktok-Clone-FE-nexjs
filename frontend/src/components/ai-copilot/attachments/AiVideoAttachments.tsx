...
export function AiVideoAttachments({ videoUrl, onSeek }: AiVideoAttachmentsProps) {
    ...
    }, [videoUrl, clipAndSendFn, setClipAndSend, setVideoRef, videoRef])
                        ...
                        {clipSent && !isRecording && (
                            <>
                                ...
                                <button
                                    ...
                                    className='flex items-center gap-1 text-[10px] font-medium rounded-xl px-2 py-1
