...
export default function InfiniteVideoFeed({
    ...
    return (
        <>
            <div className=' max-h-screen w-full  overflow-y-auto  snap-y snap-mandatory scrollbar-hidden @container transition-all duration-400'>
                ...
                {!isLoading &&
                    posts.map((post, index) => (
                        <article
                            ...
                            {...{ [keyDataScroll]: index }}
                            className='flex items-center px-4 @5xl:ps-[3rem] @5xl:pe-[15rem]  py-4 min-h-screen snap-start snap-always transition-all duration-600'
                        >
