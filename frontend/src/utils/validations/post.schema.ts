...
export const MediaSchema = z.object({
  ...
  type: z.union([
    z.literal(MediaType.IMAGE),
    z.literal(MediaType.VIDEO),
    z.literal(MediaType.HLS_VIDEO),
  ]),
});

export const CreatePostReqBody = z.object({
  type: z.union([
    z.literal(PosterType.POST),
    z.literal(PosterType.QUOTE_POST),
    z.literal(PosterType.RE_POST),
  ]),
  audience: z.union([
    z.literal(Audience.PUBLIC),
  ...
  thumbnail: z.number().int().positive().optional(),
});
...
export const UpdatePostReqBody = z.object({
  ...
  hashtags: z.array(z.string()).optional(),
  mentions: z.array(z.number().int().positive()).optional(),
  thumbnail: z.number().int().positive().nullable().optional(),
});
