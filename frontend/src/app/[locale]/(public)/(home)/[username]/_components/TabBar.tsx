            ...
            <ul className='flex flex-row flex-grow border-b border-border max-md:justify-center'>
                {tabs.map((tab) => (
                    <li
                        ...
                        data-key={tab.id}
                        className={cn(
                            'font-semibold text-lg  flex items-center justify-center h-11 px-8 cursor-pointer text-center gap-1 text-muted-foreground   transition-all duration-300 hover:text-gray-500',
