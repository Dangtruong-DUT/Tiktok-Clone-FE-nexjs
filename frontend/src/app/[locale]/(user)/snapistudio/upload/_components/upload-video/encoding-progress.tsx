    ...
    return (
        <div className={cn('w-full space-y-3', className)}>
            ...
            <div className='flex items-center gap-1'>
                <StepDot icon={<Upload className='size-2.5' />} active={step >= 1} label='Upload' />
                <div
                    className={cn('h-px flex-1 transition-colors duration-500', step > 1 ? 'bg-brand' : 'bg-border')}
                />
                <StepDot icon={<ScanSearch className='size-2.5' />} active={step >= 2} label='Analyze' />
                <div
                    className={cn('h-px flex-1 transition-colors duration-500', step > 2 ? 'bg-brand' : 'bg-border')}
                />
                <StepDot icon={<Clapperboard className='size-2.5' />} active={step >= 3} label='Encode' />
                <div
