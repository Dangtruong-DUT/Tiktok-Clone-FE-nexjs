...
import { useGetUserIndicatorQuery } from '@/store/services/user/user.service'
import { UserIndicatorsData } from '@/types/dtos/stats/stats-response.dto'
...
export default function DirectorLineChart() {
    const t = useTranslations('SnapiStudio.dashboard.directorChart')
