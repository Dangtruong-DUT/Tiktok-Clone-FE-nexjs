...
const STATUS_STYLE: Record<string, string> = {
    ...
    scheduled: 'bg-yellow-100 text-yellow-700 border-yellow-200 dark:bg-yellow-950/40 dark:text-yellow-400 dark:border-yellow-900',
    published: 'bg-green-100 text-green-700 border-green-200 dark:bg-green-950/40 dark:text-green-400 dark:border-green-900',
                ...
                return (
                    <div className='flex gap-3 items-center py-1'>
                        <button type='button' onClick={() => setDetailOpen(true)}
                            ...
                            {thumbnail_url ? (
                                <Image src={thumbnail_url} width={52} height={72} alt=''
            ...
            cell: function Actions({ row }) {
                ...
                return (
                    <div className='flex items-center gap-1'>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href={`${SNAPISTUDIO_ROUTES.UPLOAD_POST(post.uuid)}?from=${encodeURIComponent(SNAPISTUDIO_ROUTES.CONTENT)}`}>
                            ...
                            <DropdownMenuContent align='end' className='w-44'>
                                ...
                                {post.status === 'scheduled' && schedPost && (
                                    <DropdownMenuItem
                                        ...
                                        onClick={() => cancelSched(schedPost.uuid)
