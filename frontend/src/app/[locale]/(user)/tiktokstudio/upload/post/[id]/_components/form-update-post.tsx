...
export default function FormUpdatePost() {
  ...
  const isCreatePostLoading =
    createPostResult.isLoading || uploadImageResult.isLoading;
              ...
              <div className="flex mt-7 mb-2 items-center gap-2 text-sm font-semibold">
                ...
                <Tooltip>
                  ...
                  <TooltipContent align="center" className="w-2xs">
                    <p>
                      Select a cover or upload one from your device. An engaging
                      cover can capture viewers interest effectively.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </div>
                ...
                render={({ field }) => (
                  <FormItem className="w-[280px]">
                    ...
                    <Select
                      ...
                      defaultValue={
                        field?.value?.toString() ?? Audience.PUBLIC.toString()
                      }
                    >
                      <FormControl>
