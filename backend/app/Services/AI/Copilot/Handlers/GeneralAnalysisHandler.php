...
/**
 * Handles: analyze_video, analyze_hook, analyze_retention, analyze_cta, analyze_audience
 */
class GeneralAnalysisHandler extends AbstractCopilotHandler implements CopilotHandlerInterface
{
